...
function SWEP:DrawWorldModel()
    ...
    mdl:SetRenderOrigin(matrix:GetTranslation() + matrix:GetAngles():Forward() * 4.5 + matrix:GetAngles():Right() * 6 + matrix:GetAngles():Up() * -2)
    mdl:SetRenderAngles(matrix:GetAngles() + Angle(0,180,200))
    mdl:DrawModel()
end
